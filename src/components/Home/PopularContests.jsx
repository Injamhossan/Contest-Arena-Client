...
const PopularContests = () => {
    ...
    return (
        <section className="py-16 px-4 bg-gray-50/50 dark:bg-base-200">
            <div className="container mx-auto max-w-7xl">
                <div className="flex justify-between items-end mb-10">
                    ...
                    <Link to="/all-contests" className="hidden md:flex items-center gap-2 px-6 py-2.5 bg-white dark:bg-base-100 border border-gray-200 dark:border-gray-700 text-gray-700 dark:text-gray-200 rounded-full hover:bg-gray-50 dark:hover:bg-base-300 hover:border-gray-300 transition-all font-medium group text-sm shadow-sm">
                        View All 
