...
import { LogOut, User, Shield, Users, Trophy, Moon, Sun } from "lucide-react";
        ...
        <div className="navbar-end gap-2">
          {user ? (
            <div className="relative flex" ref={dropdownRef}>
              <button onClick={toggleTheme} className="btn btn-ghost btn-circle mr-2 text-gray-700 dark:text-gray-200 hover:bg-[#f59f0a]">
