    ...
    <div className="pb-12">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            <div className="flex items-center gap-6">
              <div className="relative">
                <img 
                  ...
                  alt={user?.name}
                  className="w-20 h-20 rounded-full object-cover border-4 border-gray-50 dark:border-gray-800 shadow-sm"
                />
            ...
            <div className="flex gap-4">
              <button 
                ...
                className="flex items-center gap-2 px-6 py-2.5 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 font-medium rounded-lg hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors border border-gray-200 dark:border-gray-700"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {/* Participated */}
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden group transition-colors duration-300">
            <div className="flex justify-between items-start">
              ...
              <span className="bg-gray-100 dark:bg-gray-800 text-gray-600 dark:text-gray-300 text-xs font-bold px-2 py-1 rounded-full">
                All Time
              </span>
            </div>
            <div className="mt-4">
              <h3 className="text-3xl font-bold text-gray-900 dark:text-white">{stats.totalParticipations}</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm font-medium mt-1">Contests Participated</p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden group transition-colors duration-300">
            <div className="flex justify-between items-start">
              ...
              <span className="bg-amber-100 dark:bg-amber-900/40 text-amber-700 dark:text-amber-400 text-xs font-bold px-2 py-1 rounded-full">
                Champion
              </span>
            </div>
            <div className="mt-4">
              <h3 className="text-3xl font-bold text-gray-900 dark:text-white">{stats.wins}</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm font-medium mt-1">Total Wins</p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden group transition-colors duration-300">
            ...
            <div className="mt-4">
              <h3 className="text-3xl font-bold text-gray-900 dark:text-white">{stats.winRate}%</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm font-medium mt-1">Win Rate</p>
            </div>
          </div>
          ...
          <div className="bg-white dark:bg-gray-900 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 relative overflow-hidden group transition-colors duration-300">
            ...
            <div className="mt-4">
              <h3 className="text-3xl font-bold text-gray-900 dark:text-white">{stats.activeContests}</h3>
              <p className="text-gray-500 dark:text-gray-400 text-sm font-medium mt-1">Active Contests</p>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 transition-colors duration-300">
            <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-2">Win Statistics</h3>
            <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Your overall performance</p>
            ...
            <div className="flex justify-center gap-6 mt-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-sm text-gray-600 dark:text-gray-400">Wins ({stats.wins})</span>
              </div>
              <div className="flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-gray-200 dark:bg-gray-700"></span>
                <span className="text-sm text-gray-600 dark:text-gray-400">Losses ({stats.losses})</span>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-2 bg-white dark:bg-gray-900 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-800 p-6 transition-colors duration-300">
            <div className="flex items-center justify-between mb-6">
              <div>
                <h3 className="text-lg font-bold text-gray-900 dark:text-white">My Contests</h3>
                <p className="text-sm text-gray-500 dark:text-gray-400">Contests you're participating in</p>
              </div>
            ...
            <div className="space-y-4">
              {filteredParticipations.length === 0 ? (
                <div className="text-center py-12">
                  ...
                  <p className="text-gray-500 dark:text-gray-400 mt-1">You don't have any {activeTab} contests yet.</p>
                  {activeTab === 'active' && (
                    <a
                      href="/all-contests"
                ...
                filteredParticipations.map((item) => (
                  <div key={item._id} className="group flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-800 rounded-xl hover:bg-white dark:hover:bg-gray-750 hover:shadow-md transition-all border border-transparent hover:border-gray-100 dark:hover:border-gray-700">
                    <div className="flex items-center gap-4">
                      ...
                      <div>
                        <h4 className="font-bold text-gray-900 dark:text-white group-hover:text-[#4a37d8] transition-colors line-clamp-1">
                          {item.contestId?.name}
                        </h4>
                        <span className="inline-block px-2 py-0.5 mt-1 bg-gray-200 dark:bg-gray-700 text-gray-600 dark:text-gray-300 text-xs font-medium rounded">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      {activeTab === 'active' && (
                        <button
                          ...
                          className="p-2 text-gray-400 hover:text-[#4a37d8] hover:bg-[#4a37d8]/5 dark:hover:bg-[#4a37d8]/20 rounded-full transition-colors"
            ...
            <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-800 text-center">
              <a 
                href="/all-contests"
                className="text-sm font-bold text-gray-900 dark:text-white hover:text-[#4a37d8] transition-colors"
              >
                View All Contests
              </a>
            </div>
